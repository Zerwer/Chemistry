# Combines both acidic and basic data into one file that is either basic, acidic or amphoteric
...
# Gather all bases, if already in acids remove and add to amphoteric, prevent duplicates for both bases and amphoterics
...
for acid in acids: new_data.write(acid + ' 0\n')
for base in bases: new_data.write(base + ' 1\n')
for both in amphoteric: new_data.write(both + ' 2\n')
