...
# Either works very well for some molecules if similar ones are known and very
#   poorly for others when they are not
# Due to lack of data and the majority of the split going to reference the
#   accuracy is low
import numpy as np
import pickle
...
# X is 512 of the most similar molecules see common/functions/pka_similarities.py
for acid in test:
