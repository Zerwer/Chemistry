"""
Model predicts boiling point in a similar way as the reverse gse regression for melting point
Method yielded lower accuracy as to be expected but higher than just the fingerprint
"""
